...
///         ]
///
/// let parameters = CaptureOptionalDocumentParametersBuilder(
///             seqNo: 追加書類ターム番号,
///             maxPages: 最大枚数,
///             optionalDocumentType: 追加書類コード,
///             optionalDocumentName: 追加書類名)
///             .build()
/// </pre>
SWIFT_CLASS("_TtC6Liquid33CaptureOptionalDocumentParameters")
@interface CaptureOptionalDocumentParameters : NSObject
/// 追加書類ターム番号
@property (nonatomic, readonly) NSInteger seqNo;
/// 最大枚数
@property (nonatomic, readonly) NSInteger maxPages;
/// 追加書類コード
@property (nonatomic, readonly, copy) NSString * _Nonnull optionalDocumentType;
/// 追加書類名
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull optionalDocumentName;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// 追加書類撮影ファンクション用設定値ビルダー
SWIFT_CLASS("_TtC6Liquid40CaptureOptionalDocumentParametersBuilder")
@interface CaptureOptionalDocumentParametersBuilder : NSObject
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
///   </li>
/// </ul>
- (nonnull instancetype)initWithSeqNo:(NSInteger)seqNo maxPages:(NSInteger)maxPages optionalDocumentType:(NSString * _Nonnull)optionalDocumentType optionalDocumentName:(NSDictionary<NSString *, NSString *> * _Nonnull)optionalDocumentName OBJC_DESIGNATED_INITIALIZER;
///
- (CaptureOptionalDocumentParameters * _Nonnull)build SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class MyNumberCardIntegratedDriverLicenseData;
enum Sex : NSInteger;
...
/// マイナ免許証情報
@property (nonatomic, strong) MyNumberCardIntegratedDriverLicenseData * _Nullable myNumberCardIntegratedDriverLicenseData;
/// 郵便番号
...
/// 照合番号B(14桁)
  ChipErrorCredentialTypeVerificationCodeB = 4,
/// マイナ免許証暗証番号(4桁)
  ChipErrorCredentialTypeMynumberCardIntegratedDriverLicensePin = 5,
};
...
/// <pre>
/// // 例:
/// let parameters = CollateFaceParametersBuilder(
///     idFaceImage: 「本人確認書類の顔写真」画像,
///     faceImage: 「本人容貌」画像)
///     .build()
/// </pre>
SWIFT_CLASS("_TtC6Liquid21CollateFaceParameters")
@interface CollateFaceParameters : NSObject
/// 「本人確認書類の顔写真」画像
@property (nonatomic, readonly, strong) UIImage * _Nonnull idFaceImage;
/// 「本人容貌」画像
@property (nonatomic, readonly, strong) UIImage * _Nonnull faceImage;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// 容貌照合ファンクション用設定値ビルダー
SWIFT_CLASS("_TtC6Liquid28CollateFaceParametersBuilder")
@interface CollateFaceParametersBuilder : NSObject
/// \param idFaceImage 「本人確認書類の顔写真」画像
///
/// \param faceImage 「本人容貌」画像
///
- (nonnull instancetype)initWithIdFaceImage:(UIImage * _Nonnull)idFaceImage faceImage:(UIImage * _Nonnull)faceImage OBJC_DESIGNATED_INITIALIZER;
///
- (CollateFaceParameters * _Nonnull)build SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class ProcResult;
@class FacePhotoVerification;

/// 容貌照合ファンクションの結果
SWIFT_CLASS("_TtC6Liquid17CollateFaceResult")
@interface CollateFaceResult : NSObject
/// 処理結果
...
/// マイナンバーカード（＋免許情報）
  IdDocumentTypeMynumberCardIntegratedDriverLicense = 24,
};
...
/// マイナンバーカード（＋免許情報）
  IdDocumentTypeJpkiMynumberCardIntegratedDriverLicense = 3,
};
...
@class IntegratedDriverLicenseCredential;
...
/// let parameters = IdentifyIdChipNonInteractiveParametersBuilder(password: 署名用電子証明書のパスワード)
///     .setDocumentTypeJpki(本人確認書類種別(公的個人認証用))
///     .setCredential(VerificationCodeACredential(照合番号A))
///     .setBase64TargetData(電子署名生成処理で使用する電子署名対象データをBASE64エンコードした値)
///     .build()
///
...
/// let parameters = IdentifyIdChipNonInteractiveParametersBuilder(password: 署名用電子証明書のパスワード)
///     .setDocumentTypeJpki(本人確認書類種別(公的個人認証用))
///     .setCredential(CardInfoInputAssistanceCredential(券面事項入力補助用暗証番号))
///     .setBase64TargetData(電子署名生成処理で使用する電子署名対象データをBASE64エンコードした値)
///     .build()
///
/// // 例: マイナンバーカード（＋免許情報）
/// let parameters = IdentifyIdChipNonInteractiveParametersBuilder(password: 署名用電子証明書のパスワード)
///     .setDocumentTypeJpki(本人確認書類種別(公的個人認証用))
///     .setIntegratedDocumentCredential(IntegratedDriverLicenseCredential(マイナ免許証暗証番号))
///     .setBase64TargetData(電子署名生成処理で使用する電子署名対象データをBASE64エンコードした値)
///     .build()
/// </pre>
...
/// 認証情報・マイナンバーカード一体化書類情報取得用（マイナ免許証暗証番号）
@property (nonatomic, readonly, strong) IntegratedDriverLicenseCredential * _Nullable integratedDocumentCredential;
...
/// 認証情報・マイナンバーカード一体化書類情報取得用
/// \param integratedDocumentCredential 認証情報・マイナンバーカード一体化書類情報取得用
///
- (IdentifyIdChipNonInteractiveParametersBuilder * _Nonnull)setIntegratedDocumentCredential:(IntegratedDriverLicenseCredential * _Nonnull)integratedDocumentCredential;
///
...
/// 認証情報・マイナンバーカード一体化書類情報取得用
SWIFT_PROTOCOL("_TtP6Liquid28IntegratedDocumentCredential_")
@protocol IntegratedDocumentCredential
@end


/// 認証情報・マイナンバーカード一体化書類情報取得用（マイナ免許証暗証番号）
SWIFT_CLASS("_TtC6Liquid33IntegratedDriverLicenseCredential")
@interface IntegratedDriverLicenseCredential : NSObject <IntegratedDocumentCredential>
/// マイナ免許証暗証番号
@property (nonatomic, readonly, copy) NSString * _Nonnull pin;
/// \param pin マイナ免許証暗証番号
///
- (nonnull instancetype)initWithPin:(NSString * _Nonnull)pin OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
@interface LiquidEkyc (SWIFT_EXTENSION(Liquid))
/// 容貌照合ファンクション
/// \param collateFaceParameters 容貌照合ファンクション用設定値
///
/// \param completion ファンクションの処理結果が返ります
///
+ (void)collateFaceWithParameters:(CollateFaceParameters * _Nonnull)collateFaceParameters completion:(void (^ _Nonnull)(CollateFaceResult * _Nonnull))completion;
@end
...
@class VerifyIdChipSupplementaryNonInteractiveParameters;
@class VerifyIdChipSupplementaryNonInteractiveResult;

@interface LiquidEkyc (SWIFT_EXTENSION(Liquid))
/// 書類ICカード付帯情報送信ファンクション（画面なし）
/// \param parameters 書類ICカード付帯情報送信ファンクション（画面なし）用設定値
///
/// \param completion ファンクションの処理結果が返ります
///
+ (void)verifyIdChipSupplementaryNonInteractive:(VerifyIdChipSupplementaryNonInteractiveParameters * _Nonnull)parameters completion:(void (^ _Nonnull)(VerifyIdChipSupplementaryNonInteractiveResult * _Nonnull))completion;
@end
...
/// returns:
/// 連携ID
+ (NSString * _Nonnull)startVerifyStandaloneWithEndpoint:(NSURL * _Nonnull)endpoint apiKey:(NSString * _Nonnull)apiKey completion:(void (^ _Nonnull)(ProcResult * _Nonnull))completion SWIFT_WARN_UNUSED_RESULT;
@end


@class OptionalDocumentCapturingResult;
...
///   </li>
///   <li>
///     captureOptionalDocumentParameters: 追加書類撮影ファンクション用設定値
///   </li>
///   <li>
///     viewController: 指定された viewController 上で画面が表示されます
///   </li>
...
///   </li>
/// </ul>
+ (void)captureOptionalDocument:(CaptureOptionalDocumentParameters * _Nonnull)captureOptionalDocumentParameters on:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(OptionalDocumentCapturingResult * _Nonnull))completion;
@end
...
/// マイナ免許証情報
SWIFT_CLASS("_TtC6Liquid39MyNumberCardIntegratedDriverLicenseData")
@interface MyNumberCardIntegratedDriverLicenseData : NSObject
/// 運転免許証色区分
@property (nonatomic, copy) NSString * _Nullable colorCategory;
/// 運転免許証条件配列
@property (nonatomic, copy) NSArray<NSString *> * _Nullable conditions;
/// 運転免許証種類配列
@property (nonatomic, copy) NSArray<NSString *> * _Nullable types;
/// 運転免許証備考配列
@property (nonatomic, copy) NSArray<NSString *> * _Nullable remarks;
/// 運転免許証免許の年月日配列
@property (nonatomic, copy) NSArray<NSString *> * _Nullable acquisitionDates;
/// マイナ免許証免許情報記録番号
@property (nonatomic, copy) NSString * _Nullable recordNumber;
/// マイナ免許証有効期間の末日
...
/// パスワード・マイナンバーカード（＋免許情報）用
SWIFT_CLASS("_TtC6Liquid43MyNumberCardIntegratedDriverLicensePassword")
@interface MyNumberCardIntegratedDriverLicensePassword : NSObject <VerifyIdChipPassword>
/// 照合番号B
@property (nonatomic, readonly, copy) NSString * _Nonnull myNumberPassword;
/// 生年の和暦西暦
@property (nonatomic, readonly) enum BirthYearCalendarType birthYearCalendarType;
/// マイナ免許証暗証番号
@property (nonatomic, readonly, copy) NSString * _Nonnull integratedDriverLicensePin;
/// コンストラクタ
/// \param myNumberPassword 照合番号B
///
/// \param birthYearCalendarType 生年の和暦西暦
///
/// \param integratedDriverLicensePin マイナ免許証暗証番号
///
- (nonnull instancetype)initWithMyNumberPassword:(NSString * _Nonnull)myNumberPassword birthYearCalendarType:(enum BirthYearCalendarType)birthYearCalendarType integratedDriverLicensePin:(NSString * _Nonnull)integratedDriverLicensePin OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// パスワード・マイナンバーカード（＋個人番号）用
SWIFT_CLASS("_TtC6Liquid32MyNumberCardWithMyNumberPassword")
@interface MyNumberCardWithMyNumberPassword : NSObject <VerifyIdChipPassword>
/// 照合番号B
@property (nonatomic, readonly, copy) NSString * _Nonnull password;
/// 生年の和暦西暦
@property (nonatomic, readonly) enum BirthYearCalendarType birthYearCalendarType;
/// 認証情報・個人番号取得用
@property (nonatomic, readonly, strong) id <WithMyNumberCredential> _Nonnull credential;
/// コンストラクタ
/// \param password 照合番号B
///
/// \param birthYearCalendarType 生年の和暦西暦
...
/// \param credential 認証情報・個人番号取得用
///
- (nonnull instancetype)initWithPassword:(NSString * _Nonnull)password birthYearCalendarType:(enum BirthYearCalendarType)birthYearCalendarType credential:(id <WithMyNumberCredential> _Nonnull)credential OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// 発行元
@property (nonatomic, copy) NSString * _Nullable issuingAuthority;
/// 氏名変更フラグ<br />
/// OCRの変更検知オプションを契約している場合のみ返却される<br />
...
/// 追加書類撮影ファンクションの結果
SWIFT_CLASS("_TtC6Liquid31OptionalDocumentCapturingResult")
@interface OptionalDocumentCapturingResult : NSObject
/// 処理結果
@property (nonatomic, readonly, strong) ProcResult * _Nonnull result;
/// 追加書類ターム番号
@property (nonatomic, readonly) NSInteger seqNo;
/// 追加書類コード
@property (nonatomic, readonly, copy) NSString * _Nullable optionalDocumentType;
/// 追加書類画像
@property (nonatomic, readonly, copy) NSArray<UIImage *> * _Nullable optionalDocumentImages;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// パスワード・在留カード用
SWIFT_CLASS("_TtC6Liquid21ResidenceCardPassword")
@interface ResidenceCardPassword : NSObject <VerifyIdChipPassword>
/// 在留カード番号
@property (nonatomic, readonly, copy) NSString * _Nonnull cardNumber;
/// コンストラクタ
/// \param cardNumber 在留カード番号
///
- (nonnull instancetype)initWithCardNumber:(NSString * _Nonnull)cardNumber OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// マイナ免許証が運転経歴情報 “mynumbercard_integrated_driver_history”
  ResultStatusMynumberIntegratedDriverHistory = 25,
/// マイナ免許証の電子署名の検証に失敗 “mynumbercard_integrated_driver_license_verify_failure”
  ResultStatusMynumbercardIntegratedDriverLicenseVerifyFailure = 26,
/// マイナ免許証が有効期限切れ “mynumbercard_integrated_driver_license_expired”
  ResultStatusMynumbercardIntegratedDriverLicenseExpired = 27,
};
...
/// パスワード・特別永住者証明書用
SWIFT_CLASS("_TtC6Liquid43SpecialPermanentResidentCertificatePassword")
@interface SpecialPermanentResidentCertificatePassword : NSObject <VerifyIdChipPassword>
/// 特別永住者証明書番号
@property (nonatomic, readonly, copy) NSString * _Nonnull cardNumber;
/// コンストラクタ
/// \param cardNumber 特別永住者証明書番号
///
- (nonnull instancetype)initWithCardNumber:(NSString * _Nonnull)cardNumber OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
/// 非法令 IC読取方式（電子署名検証なし・本人容貌なし・オフライン）
  VerificationMethodReadOffline = 11,
};
...
SWIFT_CLASS("_TtC6Liquid26VerifyFaceManualParameters")
@interface VerifyFaceManualParameters : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Liquid33VerifyFaceManualParametersBuilder")
@interface VerifyFaceManualParametersBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// <pre>
/// // 例: 運転免許証時
/// let parameters = VerifyIdChipNonInteractiveParametersBuilder(password: DriverLicensePassword(pin1: 暗証番号1, pin2: 暗証番号2))
///     .build()
///
/// // 例: マイナンバーカード時
/// let parameters = VerifyIdChipNonInteractiveParametersBuilder(password: MyNumberCardPassword(password: 照合番号B, birthYearCalendarType: 生年の和暦西暦))
///     .build()
///
/// // 例: 在留カード時
/// let parameters = VerifyIdChipNonInteractiveParametersBuilder(password: ResidenceCardPassword(cardNumber: 在留カード番号))
///     .build()
///
/// // 例: 特別永住者証明書時
/// let parameters = VerifyIdChipNonInteractiveParametersBuilder(password: SpecialPermanentResidentCertificatePassword(cardNumber: 特別永住者証明書番号))
///     .build()
///
/// // 例: マイナンバーカード（＋個人番号）時
/// let parameters = VerifyIdChipNonInteractiveParametersBuilder(password: MyNumberCardWithMyNumberPassword(password: 照合番号B, birthYearCalendarType: 生年の和暦西暦, credential: VerificationCodeACredential(pin: 照合番号A)))
///     .build()
///
/// // 例: マイナンバーカード（＋免許情報）時
/// let parameters = VerifyIdChipNonInteractiveParametersBuilder(password: MyNumberCardIntegratedDriverLicensePassword(myNumberPassword: 照合番号B, birthYearCalendarType: 生年の和暦西暦, integratedDriverLicensePin: マイナ免許証暗証番号))
///     .build()
/// </pre>
...
/// マイナンバーカード時: MyNumberCardPassword<br/>
/// 在留カード時: ResidenceCardPassword<br/>
/// 特別永住者証明書時: SpecialPermanentResidentCertificatePassword<br/>
/// マイナンバーカード（＋個人番号）時: MyNumberCardWithMyNumberPassword<br/>
/// マイナンバーカード（＋免許情報）時: MyNumberCardIntegratedDriverLicensePassword
...
/// 書類ICカード付帯情報送信ファンクション（画面なし）用設定値
/// <pre>
/// // 例:
/// let parameters = VerifyIdChipSupplementaryNonInteractiveParametersBuilder(document: 本人確認書類種別)
///     .setBackImage(裏面画像)
///     .build()
/// </pre>
SWIFT_CLASS("_TtC6Liquid49VerifyIdChipSupplementaryNonInteractiveParameters")
@interface VerifyIdChipSupplementaryNonInteractiveParameters : NSObject
/// 本人確認書類種別
@property (nonatomic, readonly) enum IdDocumentType document;
/// 裏面画像<br />
/// <ul>
...
///   </li>
///   <li>
///     解像度: 横1920x縦1920ピクセル以内<br />
///   </li>
///   <li>
///     容量: 500,000バイト以内
///   </li>
/// </ul>
@property (nonatomic, readonly, copy) NSData * _Nullable backImage;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// 書類ICカード付帯情報送信ファンクション（画面なし）用設定値ビルダー
SWIFT_CLASS("_TtC6Liquid56VerifyIdChipSupplementaryNonInteractiveParametersBuilder")
@interface VerifyIdChipSupplementaryNonInteractiveParametersBuilder : NSObject
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
///   </li>
/// </ul>
- (nonnull instancetype)initWithDocument:(enum IdDocumentType)document OBJC_DESIGNATED_INITIALIZER;
/// 裏面画像<br />
/// <ul>
///   <li>
///     形式: JPEG<br />
...
///   </li>
/// </ul>
- (VerifyIdChipSupplementaryNonInteractiveParametersBuilder * _Nonnull)setBackImage:(NSData * _Nonnull)backImage;
///
- (VerifyIdChipSupplementaryNonInteractiveParameters * _Nonnull)build SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// 書類ICカード付帯情報送信ファンクション（画面なし）の結果
SWIFT_CLASS("_TtC6Liquid45VerifyIdChipSupplementaryNonInteractiveResult")
@interface VerifyIdChipSupplementaryNonInteractiveResult : NSObject
/// 処理結果
@property (nonatomic, strong) ProcResult * _Nonnull result;
/// 「本人容貌」画像と「本人確認書類の顔写真」画像の同一判定結果
@property (nonatomic, strong) FacePhotoVerification * _Nullable facePhotoVerification;
